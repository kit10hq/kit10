...
const app = new Hono();
app.get('/', (c) => handler(c, 'index+page.html'));
app.get('/profile/inventory', (c) => handler(c, 'profile/inventory+page.html'));
app.get('/profile/:id', (c) => handler(c, 'profile/[id]+page.html'));
app.get('*', (c) => handler(c));
